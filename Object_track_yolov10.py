...
faceProto = "# List of age ranges corresponding to age detection model outputsopencv_face_detector.pbtxt"
...
model = YOLO(r'C:\Users\asus\Desktop\age and gender detection\age and gender detection\yolov10s.pt')
...
#Define a shift value for adjusting UI elements or processing
shift_value = 110
...
with open('detections_yolov10s.json', 'w', encoding='utf-8') as f:
